...
class MyCustomMessage(metaclass=Metaclass_MyCustomMessage):
    ...
    def __init__(self, **kwargs):
        ...
        self.my_integer = kwargs.get('my_integer', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.my_integer != other.my_integer:
            return False
    ...
    @builtins.property
    def my_integer(self):
        """Message field 'my_integer'."""
        return self._my_integer

    @my_integer.setter
    def my_integer(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'my_integer' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'my_integer' field must be an integer in [-2147483648, 2147483647]"
        self._my_integer = value
