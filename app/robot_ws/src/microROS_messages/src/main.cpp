...
void timer_callback(rcl_timer_t * timer, int64_t last_call_time)
{
  ...
  if (timer != NULL) {
    ...
    msg.data++;
    RCSOFTCHECK(rcl_publish(&publisher1, &custom_msg, NULL));
  }
}
...
#error "No transport defined"
  ...
  msg.data = 0;
  custom_msg.bool_test = true;
  custom_msg.byte_test = 0b00;
  custom_msg.char_test = 'p';
  custom_msg.float32_test = 3.1416f;
  custom_msg.double_test = 1.20;
  custom_msg.int8_test = (int8_t) 1;
  custom_msg.uint8_test = (u_int8_t) 2;
  custom_msg.int16_test = (int16_t) 3;
  custom_msg.uint16_test = (uint16_t) 4;
  custom_msg.int32_test = (int32_t) 5;
  custom_msg.uint32_test = (uint32_t) 6;
  custom_msg.int64_test = (int64_t) 7;
  custom_msg.uint64_test = (uint64_t) 8;
}
